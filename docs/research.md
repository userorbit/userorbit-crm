...
- Missing: native calling, power dialer, provider-native SMS/WhatsApp, meeting/calendar sync, OAuth login, field-level permissions, native third-party integrations, and AI enrichment/notes.
