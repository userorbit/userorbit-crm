...
- Partial: email exists through outbound SMTP, stored events, sender rotation, first-party open/click tracking, parsed inbound reply ingestion, unsubscribe handling, and manual reply handling but lacks provider-native IMAP/Gmail/Outlook sync.
