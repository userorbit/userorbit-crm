...
- Missing: deeper native third-party integrations beyond Slack/Teams/Discord notifications, Google/Microsoft calendar sync, Twilio-compatible calling/messaging, and HubSpot imports.
