...
- Partial: pipeline management exists as a configurable drag-and-drop board with stage, forecast, owner performance, source conversion reports, dashboard widget preferences, saved report views, scheduled account/report exports, public dashboard sharing, embeddable dashboard widgets, and compact report drill-downs but lacks report alerting.
...
5. Deepen reporting: report alerting.
