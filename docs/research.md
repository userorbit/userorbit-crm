...
- Missing: native calling, power dialer, SMS/WhatsApp, meetings, OAuth login, advanced import mapping UI, role-based access control, native third-party integrations, and AI enrichment/notes.
...
2. Harden tenancy and auth: OAuth login, workspace membership overrides, richer roles, and broader audit coverage.
