...
- Partial: pipeline management exists as a configurable drag-and-drop board with stage, forecast, owner performance, and source conversion reports but lacks deeper dashboard customization.
