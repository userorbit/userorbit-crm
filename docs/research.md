...
- Missing: native calling, power dialer, provider-native SMS/WhatsApp, OAuth calendar sync, broader native third-party integrations beyond Slack, and AI enrichment/notes.
