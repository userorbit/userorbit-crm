...
- Missing: native calling, power dialer, full Google/Microsoft OAuth calendar sync, broader native third-party integrations beyond Slack, and deeper AI enrichment such as external company research.
