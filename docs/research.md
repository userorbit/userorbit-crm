...
- Missing: deeper native third-party integration presets beyond the current Slack/Teams/Discord/Zapier/Segment/Airtable/GitHub notifications and automation, Google/Microsoft calendar sync, Twilio-compatible calling/messaging, HubSpot/Pipedrive/Salesforce imports, generic enrichment connectors, and warehouse export endpoints.
