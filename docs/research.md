...
- Missing: native calling, power dialer, provider-native SMS/WhatsApp, OAuth calendar sync, OAuth login, field-level permissions, broader native third-party integrations, and AI enrichment/notes.
...
2. Harden tenancy and auth: OAuth login, richer roles, fine-grained permissions, and periodic audit review tooling.
